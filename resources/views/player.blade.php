...
<!-- Mirrored from htmlstream.com/front/html/landings/classic-software.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 21 Mar 2020 02:52:01 GMT -->
<head>
  <!-- Title -->
  <title>Players</title>
...
@else
                  <a class="btn btn-sm btn-primary transition-3d-hover text-capitalize" href="/{{Auth::guard('player')->user()->username }}" target="_blank">
            {{Auth::guard('player')->user()->username ?? 'Nothing Here'}}
                  </a>
@endif
  ...
  <main id="content" role="main">
    ...
    <div class="overflow-hidden">
      <div class="container space-top-2 space-top-lg-3 space-bottom-3">
        <!-- Title -->
        <div class="w-md-80 w-lg-50 text-center mx-md-auto mb-5 mb-md-9">
          <h2>Why Join Scout54 as a player?</h2>
        ...
        <div class="row">
          ...
          <div class="col-sm-8 col-md-6 col-lg-4">
            ...
            <article class="position-relative">
              <a class="card shadow-none bg-img-hero w-100 min-h-450rem transition-3d-hover" href="#" style="background-image: url(../../images/1587170021.jpeg);">
                <div class="card-body">
                  <h4>Scout54</h4>
                  <p class="text-body">Our Motto Here</p>
                </div>
...
<!-- Mirrored from htmlstream.com/front/html/landings/classic-software.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 21 Mar 2020 02:52:03 GMT -->
</html>
